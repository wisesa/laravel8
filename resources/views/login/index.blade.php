    ...
    <div class="col-md-4">
        ...
        <main class="form-signin w-100 m-auto" style="padding-top:200px;">
            ...
            <form action="/login" method="post">
                ...
                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="floatingInput" placeholder="Email Address" autofocus required value="{{ old('email') }}">
                </div>
                @error('email')
