        ...
        <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>
                        <small class="text-muted">
                            By : <a class="text-decoration-none" href="/posts?author={{ $post->author->username }}">{{ $post->author->name }}</a> in <a href="/posts?category={{ $post->category->slug }}" class="text-decoration-none">{{ $post->category->name }}</a> 
